  ...
  useEffect(() => {
    ...
    const Timer = setTimeout(() => {
      setTimeLeft(prevTimeLeft => {
        if (prevTimeLeft <= 1) {
          ResendRef.current.style.color = "#0066CC";
          setIsActive(false);
          return 0;
        }
          ...
          {otpShow
            ? <section className="steps step-1 active rounded-[40px] relative">
              <div className="w-[100%] bg-[#EFEDEE]  pt-[30px] z-[999]  pb-[20px] fixed top-[0px] ">
                <div className="bg-white w-[83%] h-[5px] mx-auto rounded-full">
                  <div className="bg-[#0066CC]  rounded-full w-[18%] h-[5px] "></div>
                </div>
              </div>
              ...
              <button disabled={isActive} ref={ResendRef} onClick={ResendOtpHandler} className="mt-[40px] font-[600] text-[16px] text-[#0066CC]">Resend Otp</button>
              <button
            ...
            : <section className="steps step-1 active rounded-[40px] relative ">
              ...
              <div className="text-start mt-[10px]">
                <h1 className="text-[28px] max-_430_:text-[26px] font-[600] max-_430_:w-[300px]">
                  Your Meet Greek Singles identity &#128526;
                </h1>
              ...
              <div className="mt-[20px] w-[100%]">
                <div className="border-gray-300 border-[2px] rounded-[10px] focus-within:border-[#0066CC]">
                  <PhoneInput
