...
const Gender2 = () => {
  const { setPreference } = useContext(MyContext);
          ...
          <section className="steps step-1 active rounded-[40px] relative ">
            ...
            <div className="w-[100%] bg-[#EFEDEE]  pt-[30px] z-[999]  pb-[20px] fixed top-[0px] ">
              <div className="bg-white w-[83%] h-[5px] mx-auto rounded-full">
                <div className="bg-[#0066CC]  rounded-full w-[81%] h-[5px] "></div>
              </div>
            </div>
            {/* <------------------ Title ---------------------> */}
            ...
            <div className="w-[100%] ">
              {
                button.map((el, index) => {
                  return <div key={index}
                    ...
                    className={`px-[15px] flex items-center justify-between mt-[15px] cursor-pointer py-[15px] rounded-[10px] border-[2px] ${selectBtn === el ? "border-[#0066CC]" : "border-gray-300"}`}
                  >
