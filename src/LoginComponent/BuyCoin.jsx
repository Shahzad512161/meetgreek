            ...
            <div className="col-xl-12">
              <div className="card card-rounded mb-4">
                <div className="card-body card-py-1 flex justify-between items-center">
                  ...
                  <Link to='/history' className="border-[2px] border-[#0066CC] text-[#0066CC] rounded-[10px] px-[15px] py-[8px]">
                      ...
                      coiPackage.map((item, index) => {
                        ...
                        >
                          <IoIosCheckmarkCircle
                            ...
                            className="absolute w-[25px] h-[25px] text-[#0066CC] -right-[8px] -top-[8px] z-[333] bg-white rounded-full"
                          />
          ...
          <div onClick={(e) => e.stopPropagation()} className="bottom-sheet-content2 relative">
            ...
            <div className="mt-[20px]">
              <input
                ...
                type="number"
                className={`border-[2px] w-[100%] ${index === 1 ? input ? "outline-[#0066CC]" : "border-red-500 outline-none" : "border-gray-300 outline-[#0066CC]"}  rounded-[10px] px-[15px] py-[8px]`}
            ...
            {selectType === "UPI" ? (
              <div className="">
                ...
                <input
                  ...
                  className={`border-[2px] w-[100%] ${index === 2 ? upi ? "outline-[#0066CC]" : "border-red-500 outline-none" : "border-gray-300 outline-[#0066CC]"}  rounded-[10px] px-[15px] py-[8px]`}
                  placeholder={t("UPI")}
                />
              ...
              <div className="">
                <div className="">
                  ...
                  <input
                    type="text"
                    className={`border-[2px] w-[100%] ${index === 3 ? accountNumber ? "outline-[#0066CC]" : "border-red-500 outline-none" : "border-gray-300 outline-[#0066CC]"}  rounded-[10px] px-[15px] py-[8px]`}
                ...
                <div className="">
                  ...
                  <input
                    type="text"
                    className={`border-[2px] w-[100%] ${index === 3 ? bankName ? "outline-[#0066CC]" : "border-red-500 outline-none" : "border-gray-300 outline-[#0066CC]"}  rounded-[10px] px-[15px] py-[8px]`}
                ...
                <div className="">
                  ...
                  <input
                    type="text"
                    className={`border-[2px] w-[100%] ${index === 3 ? accountName ? "outline-[#0066CC]" : "border-red-500 outline-none" : "border-gray-300 outline-[#0066CC]"}  rounded-[10px] px-[15px] py-[8px]`}
                ...
                <div className="">
                  ...
                  <input
                    type="text"
                    className={`border-[2px] w-[100%] ${index === 3 ? ifsc ? "outline-[#0066CC]" : "border-red-500 outline-none" : "border-gray-300 outline-[#0066CC]"}  rounded-[10px] px-[15px] py-[8px]`}
              ...
              <div className="">
                ...
                <input
                  type="text"
                  className={`border-[2px] w-[100%] ${index === 4 ? email ? "outline-[#0066CC]" : "border-red-500 outline-none" : "border-gray-300 outline-[#0066CC]"}  rounded-[10px] px-[15px] py-[8px]`}
